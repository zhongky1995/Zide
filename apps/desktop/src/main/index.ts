...
import { registerAITaskHandlers } from './ipc/aiTask';
import { registerStoryBibleHandlers } from './ipc/storyBible';
import { registerPlotBoardHandlers } from './ipc/plotBoard';
import { registerLoreMemoryHandlers } from './ipc/loreMemory';
import { registerManuscriptHandlers } from './ipc/manuscript';
import { registerRetconHandlers } from './ipc/retcon';
...
app.whenReady().then(async () => {
  ...
  registerStoryBibleHandlers();
  registerPlotBoardHandlers();
  registerLoreMemoryHandlers();
  registerManuscriptHandlers();
  registerRetconHandlers();
